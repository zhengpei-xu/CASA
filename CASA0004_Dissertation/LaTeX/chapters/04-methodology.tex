...
\begin{figure}[h]
  ...
  \caption[Analytical framework]{Analytical framework.}
  \label{fig:methods}
\end{figure}
...
\begin{table}[htbp]
  ...
  reduced by one level to a minimum of LTS 2; roundabouts with both a segregated cycle facility and traffic signal control are classified as LTS 1}
\end{table}
